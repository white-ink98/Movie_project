...
class Actor(models.Model):
    ...
    class Meta:
        verbose_name = "Актотри та режисери"
        verbose_name_plural = "Актотри та режисери"
...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField("Бюджет", default=0,
                                         help_text="Вказувати суму у доларах")
    fees_in_usa = models.PositiveIntegerField(
        "Сбори в США", default=0, help_text="Вказувати суму у доларах"
    )
    fess_in_world = models.PositiveIntegerField(
        "Сбори в мире", default=0, help_text="указывать сумму в долларах"
    )
...
class MovieShots(models.Model):
    ...
    class Meta:
        verbose_name = "Кадр з фильму"
        verbose_name_plural = "Кадри з фильму"
