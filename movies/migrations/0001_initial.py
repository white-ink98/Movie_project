    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Вказувати суму в доларах', verbose_name='Сбори в США')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='Вказувати суму в доларах', verbose_name='Сбори в світі')),
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.category', verbose_name='Категорії')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.reviews', verbose_name='Родич')),
            ],
            options={
                'verbose_name': 'Відгук',
